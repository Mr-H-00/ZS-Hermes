...
def test_lock_excludes_full_docling_and_includes_local_bge_runtime() -> None:
    """锁文件排除完整 Docling，同时包含本地 BGE-M3 的真实运行依赖。"""
    ...
    assert {"torch", "transformers"}.issubset(package_names)
